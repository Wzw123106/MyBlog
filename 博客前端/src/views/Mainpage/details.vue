    ...
    <div class="deta-head">
        ...
        <div class="de-content">
                ...
                <div class="content">
                  ...
                  <!-- 富文本样式代码不生效解决 -->
                    <div  class="ql-snow" style="color:#777;">
                         <div class="ql-editor" v-html="this.nra"  style="line-height:25px;"></div>
                    </div>
            ...
            <div class="xk">
              ...
              <div class="gif"> 
                <img src="../../assets/img/001.gif" alt="">
              </div>
            ...
            <div class="de-fbpl" v-show="yes">
                <h3 style="color:#777;">发表评论</h3>
                <p  style="color:#777">评论<img src="../../assets/img/hx.png" alt=""></p>
                <input type="text" placeholder="评论内容 , 不可为空" v-model="comment" class="ings">
                <ul>
                  <li class="ul-z">
  ...
  methods: {
      ...
      jk(){
            ...
            this.axios.get('/gtecommentbaby').then((res)=>{
                // 获取一个根据数据长度得成随机数
                let aimg = Math.floor(Math.random()*res.data.length)
                this.pltx = res.data[aimg].imgsrc
                // console.log(this.pltx +'这是数字',aimg)
      ...
      jcna(){
         //获取随机头像
            this.axios.get('/gtecommentbaby').then((res)=>{
                // 获取一个根据数据长度得成随机数
                var aimg = Math.floor(Math.random()*res.data.length)
